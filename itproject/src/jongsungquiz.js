...
const Jongsungquiz = () => {
  ...
  const brailleList = ["ㄱ", "ㄲ", "ㄳ", "ㄴ", "ㄵ", "ㄶ", "ㄷ", "ㄹ","ㄺ", "ㄻ","ㄼ","ㄽ", "ㄾ","ㄿ", "ㅀ", "ㅁ", "ㅂ", "ㅄ", "ㅅ","ㅆ","ㅇ","ㅈ","ㅊ","ㅋ","ㅌ","ㅍ","ㅎ"];
  ...
  const handleSendToArduino = async () => {
    ...
    try {
      const requestData = {
        content: [braillePattern],
      };

      const response = await axios.post("http://192.168.214.1:80/upload", requestData, {
